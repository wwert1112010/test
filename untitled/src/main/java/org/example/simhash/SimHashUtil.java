...
public class SimHashUtil {
    ...
    public static void main(String[] args) {
        SimHashUtil simHashUtil = new SimHashUtil();
        System.out.println(simHashUtil.getMyScale(100D));
    }
    ...
    private Double getMyScale(Double scale) {
        ...
        BigDecimal temp2 = new BigDecimal("0.9").multiply(bigDecimal);
        BigDecimal res = temp1.subtract(temp2);
